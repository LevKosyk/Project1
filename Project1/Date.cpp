...
const char * Date::getSMonth(const char * lan)
{
	...
	if (strcmp(lan, "RU") == 0) {
		switch (month)
		{
		case 1: strcpy_s(tmp, 20, "������"); break;
		case 2: strcpy_s(tmp, 20, "�������"); break;
		case 3: strcpy_s(tmp, 20, "����"); break;
		case 4: strcpy_s(tmp, 20, "������"); break;
		case 5: strcpy_s(tmp, 20, "���"); break;
		case 6: strcpy_s(tmp, 20, "����"); break;
		case 7: strcpy_s(tmp, 20, "����"); break;
		case 8: strcpy_s(tmp, 20, "������"); break;
		case 9: strcpy_s(tmp, 20, "��������"); break;
		case 10: strcpy_s(tmp, 20, "�������"); break;
		case 11: strcpy_s(tmp, 20, "������"); break;
		case 12: strcpy_s(tmp, 20, "�������"); break;
		}
	}
